...
此示例演示了一个 Java Servlet Web 应用程序，该应用使用 [Microsoft 身份验证库 (MSAL) for Java](https://github.com/AzureAD/microsoft-authentication-library-for-java) 将用户登录到您的 Microsoft Entra 租户。
